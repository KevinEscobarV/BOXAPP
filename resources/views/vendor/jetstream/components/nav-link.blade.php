...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-orange-500 text-md font-semibold leading-5 text-orange-500 focus:outline-none focus:border-orange-700 transition'
